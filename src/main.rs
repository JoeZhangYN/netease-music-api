...
async fn main() {
    ...
    let state = Arc::new(AppState {
        ...
        stats,
        parse_semaphore: Arc::new(tokio::sync::Semaphore::new(rc.parse_concurrency)),
        download_semaphore: Arc::new(tokio::sync::Semaphore::new(rc.download_concurrency)),
        batch_semaphore: Arc::new(tokio::sync::Semaphore::new(rc.batch_concurrency)),
        sse_tx,
        cover_cache,
        in_flight: Arc::new(netease_infra::download::in_flight::InFlightRegistry::new()),
        dedup: DashMap::new(),
